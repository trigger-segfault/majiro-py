#!/usr/bin/env python3
#-*- coding: utf-8 -*-
"""Deploy finished changes in vscode-majiro plugin to VSCode extensions directory
"""
...
EXTENSION_DIR:str = r".vscode/extensions/vscode-majiro"
...
PLUGIN_PATH:str = os.path.join(SCRIPT_DIR, r"vscode-majiro")
...
def main(argv:list=None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description='deploy changes to vscode-majiro extension',
        add_help=True)
